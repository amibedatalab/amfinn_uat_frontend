    ...
    <SafeAreaView style={styles.container}>
      ...
      {/* <View style={styles.insightBox}>
        <View style={styles.insightLeft}>
          <Icon name="car-outline" size={30} color="#00D09E" />
          <Text style={styles.insightTitle}>Savings</Text>
          <Text style={styles.insightSubtitle}>On Goals</Text>
        </View>
        <View style={styles.insightRight}>
            <View style={styles.insightRightMain}>
            <View style={styles.rowBetween }>
            <Text style={styles.muted}>From budgeting to building wealth — your complete personal finance guide in one app.</Text>
            <Text style={styles.blackText}>$4,000.00</Text>
          </View>
          <View style = {styles.bottomborder}></View>
          <View style={styles.rowBetween}>
            <Text style={styles.muted}>Food Last Week</Text>
      ...
      {/* <View style={styles.bottomNav}>
        {[
          ...
          <TouchableOpacity key={i}>
            <Icon name={icon} size={24} color={i === 0 ? '#00D09E' : '#222'} />
          </TouchableOpacity>
        ))}
      </View> */}
      </View>
